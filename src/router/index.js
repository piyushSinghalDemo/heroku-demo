...
=======
import AddUser from '../components/userprovisioning/add_user.vue'
import ManageDataSource from '../components/datasources/manageDatasource.vue'
import ManageWorkflowTemplate from '../components/processWorkflow/manageWorkflowtemplate.vue'
...
import WorkflowTemplateList from '../components/processWorkflow/workflowtemplateList.vue'
...
import processdefinitionlist from '../components/jobManagement/processDefList.vue'
import executeProcess from '../components/jobManagement/executeProcessDef.vue'
import Businessobjectdesigner from '../components/sqlDesigner/businessobjectdesigner.vue'
import ManageAccount from '../components/templates/manage_account.vue'
import currentjoblist from '../components/jobManagement/currentjoblist.vue'
import jobhistorylist from '../components/jobManagement/jobHistoryList.vue'
...
import restorejob from '../components/jobManagement/restoreJob.vue'
import selectiverestore from '../components/jobManagement/selectiverestore'
import userlist from '../components/userprovisioning/userlist.vue'
import jobDetails from '../components/schedular/jobDetails.vue'
import schedulelist from '../components/schedular/schedulelist.vue'
import schedulejobhistory from '../components/schedular/job_history.vue'
...
=======
        {
            path: '/manageworkflowtemplate',
            name: 'ManageWorkflowTemplate',
            component: ManageWorkflowTemplate,
            meta: {
                breadcrumb: 'Home / AddWorkflowTemplate'
            }
        },
        {
            path: '/:workflow_id/editworkflotemplate',
            name: 'editWorkflowTemplate',
            component: ManageWorkflowTemplate,
            meta: {
                breadcrumb: 'Home / Workflow Template List / Edit Workflow Template'
            }
        },
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
        {
...
=======
            path: '/workflowtemplateList',
            name: 'WorkflowTemplateList',
            component: WorkflowTemplateList,
            meta: {
                breadcrumb: 'Home / WorkflowTemplateList'
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
            }
        },
        {
...
<<<<<<< HEAD
            ...
            meta: {
                breadcrumb: 'Home / Process Definition'
=======
            path: '/executeProcess/:process_definition_id',
            name: 'executeProcess',
...
=======
            path: '/stepsresult/:jobid/:mode/:status',
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
...
=======
            path: '/operationwise/:jobid/:mode/:status',
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
...
=======
            path: '/:task_id/taskhistory',
            name: 'taskhistory',
            component: TaskHistory,
            meta: {
                breadcrumb: 'Home / Manage Approval Task List / Task History'
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
            }
        },
        {
