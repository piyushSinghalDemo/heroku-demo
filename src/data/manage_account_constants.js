...
{'user_format':'YYYY-DD-MM', 'python_format':'%Y-%d-%m'}]
=======
export const DATE_TIME_FORMAT = ['DD/MM/YYYY HH:mm:ss', 'MM/DD/YYYY HH:mm:ss', 'YYYY/MM/DD HH:mm:ss', 'YYYY/DD/MM HH:mm:ss', 'DD-MM-YYYY HH:mm:ss', 'MM-DD-YYYY HH:mm:ss', 'YYYY-MM-DD HH:mm:ss', 'YYYY-DD-MM HH:mm:ss']
