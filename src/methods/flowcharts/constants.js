...
export const JOIN_OPERATOR_ARRAY_JSON =[{id:"EQUALS_TO",name:"EqualTo(=)"}
                                        ,{id:"NOT_EQUALS_TO",name:"NotEqualTo(!=)"}
                                        ,{id:"LESS_THAN",name:"LessThan(<)"}
                                        ,{id:"GREATER_THAN",name:"GraterThan(>)"}
                                        ,{id:"LESS_THAN_EQUALS_TO",name:"LessThanEqualTo(<=)"}
                                        ,{id:"GREATER_THAN_EQUALS_TO",name:"GraterThanEqualTo(>=)"}
                                        ]
export const FLITER_JOIN_OPERATOR_ARRAY_JSON =[{id:"EQUALS_TO",name:"EqualTo(=)"}
                                        ,{id:"NOT_EQUALS_TO",name:"NotEqualTo(!=)"}
                                        ,{id:"LESS_THAN",name:"LessThan(<)"}
                                        ,{id:"GREATER_THAN",name:"GraterThan(>)"}
                                        ,{id:"LESS_THAN_EQUALS_TO",name:"LessThanEqualTo(<=)"}
                                        ,{id:"GREATER_THAN_EQUALS_TO",name:"GraterThanEqualTo(>=)"}
                                        ,{id: "IS_NULL", name: "IsNull"}
                                        ,{id: "IS_NOT_NULL", name: "IsNotNull"}
                                        ,{id: "LIKE_STARTS_WITH", name: "LikeStartsWith"}
                                        ,{id: "LIKE_ENDS_WITH", name: "LikeEndWith"}
                                        ,{id: "LIKE_CONTAINS_WITH", name: "LikeContainsWith"}
