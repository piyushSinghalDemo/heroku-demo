...
=======
export function getRectangle(x, y,width,height,text){
		var rect = new joint.shapes.basic.Rect({
		// angle:2,
	    position : {
	        x : x,
	    ...
	    attrs : {
	        ...
	        text: { text: text,'font-weight':'bold'},
	    	desciption:'',
	    },
	    ports:{
...
export function getBasicCell(x, y,width,height,image,text) {
		var image = new joint.shapes.basic.Image({
		// angle:2,
	    position : {
	        x : x,
...
export function getStepList(that){
	that.Calculate_responsive_size()
	var start_point = that.space_size / 2
	var current_space_size = start_point

	var selectioncell = getBasicCell(current_space_size,10,that.cell_width,that.cell_width,that.selection_img,'Selection')

	current_space_size = current_space_size + that.cell_width + that.space_size
		...
		var archivalcell = getBasicCell(current_space_size,140,that.cell_width,that.cell_width,that.archive_img,'Archive')
