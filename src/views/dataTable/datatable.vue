                ...
                <div class="box" :class="{containerHeight: !removeContainerHeight}">
                    ...
                    <template i='tbody' slot="tbody">
                        ...
                        <tr v-else v-for="(record,index) in tableList" :key="index">
                            ...
                            <td v-for="(tableData, tableindex) in data.headers" :class="{rightAlign:tableData.align == 'right','w2':tableData.cssClass == 'w2','w16':tableData.cssClass == 'w16'}"
                                :key="tableindex" :style="{'width':tableData.width || columnWidth}">
