        ...
        <v-flex xs12 >          
          <v-layout id="regirsterContainer" row wrap>
            <v-flex xs6 offset-xs3>
              <v-layout row wrap style="background:white;padding: 10px;border-radius: 10px">
                <v-flex justify-center>
                  <img src="../../assets/images/essentio.png" alt="Smiley face">
...
=======
                   append-icon="fa-user" style="max-height:45px;margin-right:10px;"
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
                  v-model="firstName"
...
=======
                  <v-text-field label="Last Name" append-icon="fa-user" style="max-height:45px;margin-left:10px;"
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
                  v-model="lastName"
                  :rules="lastNameRules"
                  required>
...
<<<<<<< HEAD
                  ...
                  :color="colorCode"
=======
                  <v-checkbox label="I agree erpdata.cloud's Terms and condition."
                    class="customCheckbox"
                  v-model="checkbox"
                  :rules="conditionRules"
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
...
=======
                  <v-btn :loading="loading" :disabled="loading"  @click.native="loader = 'loading'" style="height:35px" @click="submit" color="success" large block>Register</v-btn>
                </v-flex>
                <v-flex xs12>
                  <span>Already have an account?</span>
                   <router-link style="color:darkred !important" to="/login">Login</router-link>
                </v-flex>
              </v-layout>
              <v-layout>
                <v-flex xs12 style="margin-top:8%">
