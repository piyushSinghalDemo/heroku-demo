...
=======
              <v-flex xs12>
                <v-btn :loading="loading" :disabled="loading"  @click.native="loader = 'loading'" @click="submit" color="success" large block type="submit">Login</v-btn>
              </v-flex>
              ...
              <v-flex xs6 class="text-sm-right">
                <router-link to="/forgotpassword" style="color:darkred !important">Forgot your Password</router-link>
              </v-flex>
            </v-layout>
            <v-layout>
...
=======
  import {AUTHENTICATE_USER, MARKLOGIN, VERIFY_CLIENT} from '../../data/url_constants.js'
