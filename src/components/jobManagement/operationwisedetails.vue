...
=======
                <template slot="items" slot-scope="props">
                  ...
                  <td>{{props.item.expected_row}}</td>
                  <td>{{props.item.process_row}}</td>
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
                  </template>
            </v-data-table>
            </v-card>
...
=======
        ...
        headers: [{ text: 'Sr. No', align: 'left', sortable: false},
          ...
          { text: 'Table Name', value: 'table_name' },
          { text: 'Expected Rows', value: "expected_row"}, 
          { text: 'Processed Rows' , value: "process_row"}],
      }
    },
    mounted () {
      this.job_id =this.$route.params.jobid
