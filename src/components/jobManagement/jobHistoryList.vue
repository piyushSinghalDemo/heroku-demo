...
<<<<<<< HEAD
                    <router-link :to="{ name: 'showjobstepsresult', params: {jobname: props.item.process_doc_details.process_definition_name, jobid: props.item.id,mode:props.item.mode_of_execution,status:props.item.status }}">Details</router-link> <router-link :to="{ name: 'operationwiseresult', params: { jobid: props.item.id,mode:props.item.mode_of_execution,
                    jobname: props.item.process_doc_details.process_definition_name, status:props.item.status }}" v-show= "props.item.mode_of_execution ==='final'">| Operation Wise Details</router-link>
=======
                    <router-link :to="{ name: 'showjobstepsresult', params: { jobid: props.item.id,mode:props.item.mode_of_execution,status:props.item.status }}">Details</router-link> <router-link :to="{ name: 'operationwiseresult', params: { jobid: props.item.id,mode:props.item.mode_of_execution,status:props.item.status }}" v-show= "props.item.mode_of_execution ==='final'">| Operation Wise Details</router-link>
...
import { GETJOBHISTORY } from '../../data/url_constants.js';
  ...
  export default {
    ...
    data () {
      return {
        ...
        headers: [
          ...
          { text: 'Mode' , value: "mode_of_execution"}, { text: 'Execution Type' , value: "exe_type"}, { text: 'Start time', value: "job_start_time"}, 
    ...
    methods: {
      getAllTodaysJob () {
        ...
        postToServer(this, config.ENGINE_API_URL + GETJOBHISTORY +status, job_data
          ).then(response => {
<<<<<<< HEAD
            debugger;
=======
