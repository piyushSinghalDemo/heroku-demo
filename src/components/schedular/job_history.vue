...
=======
              <li><a href="/">Home</a></li>
              <li><a href="/scheduledJobList">Scheduled Job List</a></li>
...
=======
                      <span v-if="props.item.status == 'MISSING'">
                          <router-link :to="{ name: 'manageschedule', params: { schedule_id: props.item.id, type:'copy' }}">
                        <v-tooltip bottom >
                            <v-icon slot="activator" class="iconFormat" >fa fa-play fs-20</v-icon>
                            <span>Execute Now</span>
                        </v-tooltip>
                        </router-link>
                         <router-link :to="{ name: 'manageschedule', params: { schedule_id: props.item.id, type:'edit' }}">
>>>>>>> 143e7fc0d6e2b98d2e8ce40376ff4db57ac6e09c
                         <v-tooltip bottom>
...
import Simplert from 'vue2-simplert'
  export default {
    ...
    components: {
         ...
         Simplert
=======
import { GET_SCHEDULER_JOB_HISTORY } from '../../data/url_constants.js';
  export default {
    name: "schedulejoblist",
    components: {
         Breadcrumb
